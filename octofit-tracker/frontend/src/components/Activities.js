    ...
    <div className="card shadow-sm mb-4">
      <div className="card-header d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
        <div>
          ...
          <p className="text-muted-small mb-0">Data fetched from the backend REST API.</p>
        </div>
      ...
      <div className="card-body">
        <form className="row g-2 mb-3">
          <div className="col-12 col-md-10">
            <label htmlFor="activitiesEndpoint" className="form-label visually-hidden">
              API Endpoint
            </label>
            <input
              id="activitiesEndpoint"
        ...
        {!rawData && !error && <div className="alert alert-info">Loading activities...</div>}
        {rawData && items.length === 0 && !error && (
          <div className="alert alert-warning">No activities available from the API.</div>
        )}
        {renderTable()}
      </div>
            ...
            <div className="modal-dialog modal-xl modal-dialog-centered" role="document">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title">Activities Raw API Response</h5>
