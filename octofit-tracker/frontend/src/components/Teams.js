...
function Teams() {
  ...
  // Codespace Django REST API endpoint: https://{CODESPACE_NAME}-8000.app.github.dev/api/teams
    ...
    <div className="card shadow-sm mb-4">
      <div className="card-header d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-2">
        <div>
          ...
          <p className="text-muted-small mb-0">Team roster data from the REST backend.</p>
        </div>
      ...
      <div className="card-body">
        <form className="row g-2 mb-3">
          <div className="col-12 col-md-10">
            <label htmlFor="teamsEndpoint" className="form-label visually-hidden">
              API Endpoint
            </label>
            <input
              id="teamsEndpoint"
        ...
        {!rawData && !error && <div className="alert alert-info">Loading teams...</div>}
        {rawData && items.length === 0 && !error && (
          <div className="alert alert-warning">No teams available from the API.</div>
        )}
        {renderTable()}
      </div>
            ...
            <div className="modal-dialog modal-xl modal-dialog-centered" role="document">
              <div className="modal-content">
                <div className="modal-header">
                  <h5 className="modal-title">Teams Raw API Response</h5>
